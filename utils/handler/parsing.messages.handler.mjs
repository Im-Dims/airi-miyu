...
const parsingMessagesHandler = (serve, m, s) => {
  try {
    ...
    if (m.key) {
      ...
      m.typeBaileys = (m.id.endsWith("WBSF")) ? "@wibusoft/baileys" : (m.id.startsWith('AKIRA')) ? "github:LT-SYAII/Bail" : (m.id.startsWith("VRDN")) ? "@client/baileys" : (m.id.startsWith("SSA")) ? "@im-dims/baileys-md" : (m.id.startsWith('B1EY') && m.id.length === 20) ? "github:@nstar-y/Bail" : (m.id.startsWith('BAE5') && m.id.length === 16) ? "@whiskeysockets/baileys@^6.6.0" : (m.id.startsWith('3EB0') && (m.id.length === 22 || m.id.length === 40)) ? "@whiskeysockets/baileys" : "no libary"
    ...
    if (m.message) {
      ...
      if (m.quoted) {
        ...
        m.quoted.typeBaileys = m.quoted.id ? (m.quoted.id.endsWith("WBSF")) ? "@wibusoft/baileys" : (m.quoted.id.startsWith('AKIRA')) ? "github:LT-SYAII/Bail" : (m.quoted.id.startsWith("VRDN")) ? "@client/baileys" : (m.quoted.id.startsWith("SSA")) ? "@im-dims/baileys-md" : (m.quoted.id.startsWith('B1EY') && m.quoted.id.length === 20) ? "github:@nstar-y/Bail" : (m.quoted.id.startsWith('BAE5') && m.quoted.id.length === 16) ? "@whiskeysockets/baileys@^6.6.0" : (m.quoted.id.startsWith('3EB0') && (m.quoted.id.length === 22 || m.quoted.id.length === 40)) ? "@whiskeysockets/baileys" : "no libary" : null
