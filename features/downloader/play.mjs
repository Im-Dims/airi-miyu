...
const handle = {
  miyxious: ["play", "music"],
  category: "#downloader",
  describe: "Cari lagu favorit kamu di fitur ini",
  run: async (m, { q, d, conn, text, repl, Func }) => {
    try {
      ...
      if (totalSeconds > 3600) return repl('Maaf, durasi audio melebihi 1 jam. Silakan cari lagu dengan durasi yang lebih pendek.')
        ...
        await conn.sendMessage(m.chat, { 
          ...
          contextInfo: { 
            externalAdReply: {
              ...
              thumbnail: await Func.fetchBuffer(nok.all[0].thumbnail || "https://telegra.ph/file/14648bf3119959bbfe434.jpg"),
